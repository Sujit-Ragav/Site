  ...
  return (
    <>
      <section class="flex min-h-screen items-stretch text-white ">
        <div
          class="relative hidden w-1/2 items-center bg-gray-500 bg-cover bg-no-repeat lg:flex"
        ...
        <div
          class="z-0 flex w-full items-center justify-center px-0 text-center md:px-16 lg:w-1/2"
          style="background-color: #161616;"
        >
          <div
            class="absolute inset-0 z-10 items-center bg-gray-500 bg-cover bg-no-repeat lg:hidden"
            style="background-image: url(https://images.unsplash.com/photo-1577495508048-b635879837f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=675&q=80);"
          >
            <div class="absolute inset-0 z-0 bg-black opacity-60"></div>
          </div>
          <div class="z-20 w-full py-6">
            <h1 class="my-6">
              <svg viewBox="0 0 247 31" class="inline-flex h-7 w-auto sm:h-8">
                <path
            ...
            <form action="" class="mx-auto w-full px-4 sm:w-2/3 lg:px-0">
              <div class="pb-2 pt-4">
                <input
                  type="email"
                  name="email"
                  id="email"
                  placeholder="Email"
                  class="block w-full rounded-sm bg-black p-4 text-lg"
                />
              </div>
              <div class="pb-2 pt-4">
                <input
              ...
              <div class="px-4 pb-2 pt-4">
                <button class="block w-full rounded-full bg-indigo-500 p-4 text-lg uppercase hover:bg-indigo-600 focus:outline-none">
                  sign in
                </button>
              </div>
      ...
      <a
        href="#"
        target="_blank"
        class="fixed bottom-0 right-0 rounded-lg bg-purple-600 p-2 text-white"
      >
        Support me
      </a>
    </>
